...
if (isset($_POST['submit'])) {
  ...
  $about = $_POST['about'];
  $sta = $_POST['status'];
  $query = "INSERT INTO users (surname,othernames,mail,rAddress, reason, status) VALUES('$surname', '$others','$mail','$radd','$about','$sta')";
  if(mysqli_query($conn,$query)){
    $msg = "<div class='text-center text-success'>New Member added successful..</div>";
                    ...
                    <div class="col-md-12">
                        <div class="card card-user" style="margin-top: 20px;">
                          <div class="card-header">
                            ...
                            <p>Add a member by filling and submitting the form.</p>
                          </div>
                          <?php echo $msg;?>
                          <div class="card-body">
                            <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-6 pl-1">
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="otherN" placeholder="Last Name" />
                                  </div>
                                </div>
                              </div>
                              <div class="row">
                              ...
                              <div class="row">
                                <div class="col-md-12">
                                  <div class="form-group">
                                    <label>Status</label>
                                    <select name="status" class="col-4 form-control" id="status">
                                      <option value="">...</option>
                              ...
                              <div class="row">
                                <div class="col-md-12">
                                  <div class="form-group">
                                    ...
                                    <textarea class="form-control textarea" name="about"></textarea>
                                  </div>
                                </div>
                              </div>
                              <div class="row">
