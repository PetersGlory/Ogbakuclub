    ...
    <div class="container px-6 mx-auto grid mt-16">
        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
            ...
            <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-2">
                <div class="flex items-center p-4 bg-teal rounded-lg shadow-xs dark:bg-gray-800">
                    <button class="text-teal-500 rounded-full dark:text-teal-100 dark:bg-teal-500">       
                        <div class="text-sm font-medium text-gray-600 dark:text-gray-400" onclick="yes()">Yes</div>
                    </button>
                </div>
                <a href="./" class="flex items-center p-4 bg-white bg-orange-100 rounded-lg shadow-xs dark:bg-gray-800"> 
                    <div class="text-orange-500 text-center rounded-full dark:text-orange-100 dark:bg-orange-500">
                        <span class="text-sm font-medium text-gray-600 dark:text-gray-400">No</span>
                    </div>
                </a>
            </div>
        </div>
